...
namespace EmploiApp.Migrations
{
    ...
    [Migration("20250403114601_addNiveauDipComLanCV")]
    partial class addNiveauDipComLanCV
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmploiApp.Models.DiplomeCV", b =>
                {
                    ...
                    b.Property<DateTime>("DateObtentation")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("EmploiApp.Models.Recruteur", b =>
                {
            ...
            modelBuilder.Entity("EmploiApp.Models.OffreEmploi", b =>
                {
                    b.HasOne("EmploiApp.Models.Recruteur", "Recruteur")
                        .WithMany("Offres")
            ...
            modelBuilder.Entity("EmploiApp.Models.Recruteur", b =>
                {
                    b.HasOne("EmploiApp.Models.ApplicationUser", "Utilisateur")
                        .WithOne("Recruteur")
                        .HasForeignKey("EmploiApp.Models.Recruteur", "UtilisateurId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
